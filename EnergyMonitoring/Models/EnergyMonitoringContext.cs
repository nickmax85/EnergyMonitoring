...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MailDistribution>(entity =>
            {
                ...
                entity.HasOne(d => d.Group)
                    .WithMany(p => p.MailDistribution)
                    .HasForeignKey(d => d.GroupId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Group_MailDistribution");

                entity.HasOne(d => d.MailDistributionNavigation)
                    .WithOne(p => p.MailDistribution)
                    .HasForeignKey<MailDistribution>(d => d.MailDistributionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
